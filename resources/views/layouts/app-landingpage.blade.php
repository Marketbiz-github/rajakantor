...
<body class="min-h-screen bg-[#31302c] text-[#222] font-[Verdana,Arial,Helvetica,sans-serif] antialiased">
  ...
  <div class="max-w-[965px] mx-auto bg-[#f5f5f5]">
    ...
    {{-- Banner --}}
    <div class="flex flex-row bg-white items-start">
      {{-- Left banner --}}
      <div class="w-[400px] h-[252px] bg-cover bg-no-repeat text-white flex flex-col gap-2 items-start"
          style="background-image: url('{{ asset('images/rajlef.gif') }}')">
        <img src="{{ asset($siteSettings->logo) }}" alt="logo" class="h-[66px]" />
        <div class="text-[26px] italic opacity-95 leading-tight p-6">"Your Office Equipment And Furniture"</div>
      </div>
      ...
      <div
        ...
        "
        class="relative w-full h-[252px] rounded-sm overflow-hidden bg-gray-300"
      >
    ...
    {{-- 3 COLUMN LAYOUT --}}
    <div class="grid grid-cols-[220px_1.5fr_190px] gap-[5px] p-2">

      {{-- LEFT SIDEBAR --}}
      <aside>
        <div class="bg-white p-3">
          <h4 class="mb-2 text-[15px] text-[#333] border-b-4 border-gray-200 pb-2">CATEGORIES</h4>
          <div class="max-h-[1000px] overflow-auto pr-1" x-data="{ openCategories: {} }">
        ...
        <div class="p-6 bg-white mt-3">
          <h5 class="text-sm font-semibold text-gray-700 mb-3 tracking-wide">Available at</h5>

          <div class="flex flex-col items-center gap-3">
            <a href="https://www.bukalapak.com/u/pusatalatkantor" target="blank">
              <img src="https://www.rajakantor.com/images/bukalapak_logo.png" width="160">
            </a>
            <a href="https://www.tokopedia.com/rajakantor" target="blank">
      ...
      <aside>
        ...
        <div class="bg-white p-3 text-[13px] leading-relaxed">
          ...
          <div class="prose text-gray-700 text-xs break-words whitespace-normal [&_*]:text-xs pb-6">
